...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-simplejson-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13125&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-simplejson-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-simplejson` can be installed with:

```
conda install types-simplejson
```

It is possible to list all of the versions of `types-simplejson` available on your platform with:
